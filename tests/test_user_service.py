...
def test_get_todos(client, mocker):
    # order = ASC
    # mocker.patch.object("api.todo.get_todos" 로 되어있는 코드를
    # mocker.patch.object(ToDoRepository,"get_todos" 로 변경
...
def test_get_todo(client, mocker):
    ...
    mocker.patch.object(
        ToDoRepository,
        "get_todo_by_todo_id",
        return_value=ToDo(id=1, contents="todo_service.py", is_done=True),
    )
...
def test_update_todo(client, mocker):
    ...
    mocker.patch.object(
        ToDoRepository,
        "update_todo",
        return_value=ToDo(id=1, contents="todo_service.py", is_done=False),
    )
